...
void Button::DrawTo(Canvas* context, int x_abs, int y_abs)
{
    ...
    for(uint32_t i = 0; i < 3; i++)
        context->DrawRect(this->pBorderColor, x_abs + i, y_abs + i, this->width - 1 - i*2, this->height - 1 - i*2);
