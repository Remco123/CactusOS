...
QEMUOPTIONS := -boot d -device VGA,edid=on,xres=1024,yres=768 -trace events=../qemuTrace.txt -usb -device usb-ehci,id=ehci -drive if=none,id=stick,file=./test.img -device usb-storage,bus=ehci.0,drive=stick
