#ifndef __CACTUSOS__CORE__DMA_H
#define __CACTUSOS__CORE__DMA_H
...
namespace CactusOS
{
    namespace core
    {
        ...
        {
        public:
            //No constructor since this is a static class, we don't need to remember any variables or something :)
            static void set_mode (common::uint8_t channel, common::uint8_t mode);
            static void set_read (common::uint8_t channel);
            static void set_write (common::uint8_t channel);
            static void set_address(common::uint8_t channel, common::uint8_t low, common::uint8_t high);
            static void set_count(common::uint8_t channel, common::uint8_t low, common::uint8_t high);
            static void mask_channel (common::uint8_t channel);
            static void unmask_channel (common::uint8_t channel);
            static void reset_flipflop (int dma);
            static void reset (int dma);
            static void set_external_page_register (common::uint8_t reg, common::uint8_t val);
            static void unmask_all (int dma);
        };
    }
}
